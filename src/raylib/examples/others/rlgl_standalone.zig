...
const raymath.h = @import("raymath.h");            // Vector2, Vector3, Quaternion and Matrix functionality

#if defined(__EMSCRIPTEN__)
    #define GLFW_INCLUDE_ES2
#endif
const GLFW/glfw3.h = @import("GLFW/glfw3.h");         // Windows/Context and inputs management
