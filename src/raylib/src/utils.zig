...
const raylib.h = @import("raylib.h");                     // WARNING: Required for: LogType enum
...
//----------------------------------------------------------------------------------
fn SetTraceLogCallback(TraceLogCallback callback) void { traceLog = callback; }              // Set custom trace log
fn SetLoadFileDataCallback(LoadFileDataCallback callback) void { loadFileData = callback; }  // Set custom file data loader
fn SetSaveFileDataCallback(SaveFileDataCallback callback) void { saveFileData = callback; }  // Set custom file data saver
fn SetLoadFileTextCallback(LoadFileTextCallback callback) void { loadFileText = callback; }  // Set custom file text loader
fn SetSaveFileTextCallback(SaveFileTextCallback callback) void { saveFileText = callback; }  // Set custom file text saver
...
fn SetTraceLogLevel(int logType) void { logTypeLevel = logType; }
