...
static fn glad_vk_load_VK_VERSION_1_0( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_vk_load_VK_VERSION_1_1( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_vk_load_VK_EXT_debug_report( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_vk_load_VK_KHR_surface( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_vk_load_VK_KHR_swapchain( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_vk_get_extensions( VkPhysicalDevice physical_device, uint32_t *out_extension_count, char ***out_extensions) int {
    uint32_t i;
...
static fn glad_vk_free_extensions(uint32_t extension_count, char **extensions) void {
    uint32_t i;
...
static fn glad_vk_has_extension(const char *name, uint32_t extension_count, char **extensions) int {
    uint32_t i;
...
static fn glad_vk_get_proc_from_userptr(const char* name, void *userptr) GLADapiproc {
    return (GLAD_GNUC_EXTENSION (GLADapiproc (*)(const char *name)) userptr)(name);
}

static fn glad_vk_find_extensions_vulkan( VkPhysicalDevice physical_device) int {
...
static fn glad_vk_find_core_vulkan( VkPhysicalDevice physical_device) int {
    int major = 1;
    int minor = 0;
...
fn gladLoadVulkanUserPtr( VkPhysicalDevice physical_device, GLADuserptrloadfunc load, void *userptr) int {
    int version;
...
fn gladLoadVulkan( VkPhysicalDevice physical_device, GLADloadfunc load) int {
