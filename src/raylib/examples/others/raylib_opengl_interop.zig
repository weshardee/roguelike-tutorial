...
const rlgl.h = @import("rlgl.h");           // Required for: rlDrawRenderBatchActive(), rlGetMatrixModelview(), rlGetMatrixProjection()
#if defined(__APPLE__)
    #include <OpenGL/gl3.h>     // OpenGL 3 library for OSX
    #include <OpenGL/gl3ext.h>  // OpenGL 3 extensions library for OSX
#else
    const glad.h = @import("glad.h");       // Required for: OpenGL functionality 
#endif
const raymath.h = @import("raymath.h");        // Required for: MatrixMultiply(), MatrixToFloat()
