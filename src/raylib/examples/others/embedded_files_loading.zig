...
const resources/audio_data.h = @import("resources/audio_data.h");   // Wave file exported with ExportWaveAsCode()
const resources/image_data.h = @import("resources/image_data.h");   // Image file exported with ExportImageAsCode()
