...
**********************************************************************************************/
    ...
    const raudio.h = @import("raudio.h");
    ...
    #endif
    const utils.h = @import("utils.h");          // Required for: fopen() Android mapping
#endif
...
// Some required types defined for MSVC/TinyC compiler
    ...
    const propidl.h = @import("propidl.h");
#endif
#endif
...
const external/miniaudio.h = @import("external/miniaudio.h");         // Audio device initialization and management
...
#include <string.h>                     // Required for: strcmp() [Used in IsFileExtension(), LoadWaveFromMemory(), LoadMusicStreamFromMemory()]
    ...
    const external/stb_vorbis.h = @import("external/stb_vorbis.h");    // OGG loading functions
#endif
    ...
    const external/jar_xm.h = @import("external/jar_xm.h");        // XM loading functions
#endif
    ...
    const external/jar_mod.h = @import("external/jar_mod.h");       // MOD loading functions
#endif
    ...
    const external/dr_wav.h = @import("external/dr_wav.h");        // WAV loading functions
#endif
    ...
    const external/dr_mp3.h = @import("external/dr_mp3.h");        // MP3 loading functions
#endif
    ...
    const external/dr_flac.h = @import("external/dr_flac.h");       // FLAC loading functions
#endif
