...
static fn glad_gl_load_GL_VERSION_1_0( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_1_1( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_1_2( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_1_3( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_1_4( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_1_5( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_2_0( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_2_1( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_3_0( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_3_1( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_3_2( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_VERSION_3_3( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_ARB_multisample( GLADuserptrloadfunc load, void* userptr) void {
    if(!GLAD_GL_ARB_multisample) return;
    glSampleCoverage = (PFNGLSAMPLECOVERAGEPROC) load("glSampleCoverage", userptr);
    glSampleCoverageARB = (PFNGLSAMPLECOVERAGEARBPROC) load("glSampleCoverageARB", userptr);
}
static fn glad_gl_load_GL_ARB_robustness( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_load_GL_KHR_debug( GLADuserptrloadfunc load, void* userptr) void {
...
static fn glad_gl_get_extensions( int version, const char **out_exts, unsigned int *out_num_exts_i, char ***out_exts_i) int {
...
static fn glad_gl_free_extensions(char **exts_i, unsigned int num_exts_i) void {
    if (exts_i != NULL) {
        unsigned int index;
        for(index = 0; index < num_exts_i; index++) {
...
static fn glad_gl_has_extension(int version, const char *exts, unsigned int num_exts_i, char **exts_i, const char *ext) int {
...
static fn glad_gl_get_proc_from_userptr(const char* name, void *userptr) GLADapiproc {
    return (GLAD_GNUC_EXTENSION (GLADapiproc (*)(const char *name)) userptr)(name);
}

static fn glad_gl_find_extensions_gl( int version) int {
...
static fn glad_gl_find_core_gl(void) int {
    int i, major, minor;
    const char* version;
    const char* prefixes[] = {
        "OpenGL ES-CM ",
...
fn gladLoadGLUserPtr( GLADuserptrloadfunc load, void *userptr) int {
    int version;
...
fn gladLoadGL( GLADloadfunc load) int {
