...
const utils.h = @import("utils.h");          // Required for: LoadFileText()
const rlgl.h = @import("rlgl.h");           // OpenGL abstraction layer to OpenGL 1.1, 2.1, 3.3+ or ES2 -> Only DrawTextPro()
...
#include <ctype.h>          // Requried for: toupper(), tolower() [Used in TextToUpper(), TextToLower()]
    ...
    const external/stb_rect_pack.h = @import("external/stb_rect_pack.h");     // Required for: ttf font rectangles packaging

    #define STBTT_STATIC
    #define STB_TRUETYPE_IMPLEMENTATION
    const external/stb_truetype.h = @import("external/stb_truetype.h");      // Required for: ttf font data reading
#endif
