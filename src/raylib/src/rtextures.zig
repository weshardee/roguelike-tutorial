...
const utils.h = @import("utils.h");              // Required for: TRACELOG() and fopen() Android mapping
...
#define STBI_NO_PNM             // Image format .ppm and .pgm
    ...
    const external/stb_image.h = @import("external/stb_image.h");         // Required for: stbi_load_from_file()
    ...
    const external/qoi.h = @import("external/qoi.h");
#endif
    ...
    const external/stb_image_write.h = @import("external/stb_image_write.h");   // Required for: stbi_write_*()
#endif
    ...
    const external/stb_image_resize.h = @import("external/stb_image_resize.h");  // Required for: stbir_resize_uint8() [ImageResize()]
#endif
